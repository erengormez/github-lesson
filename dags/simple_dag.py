...
with DAG('simple_dag', default_args=default_args, schedule='@daily', catchup=False) as dag:
    ...
    t1 = BashOperator(task_id='download_data',
                      bash_command='curl -L -o /tmp/dirty_store_transactions.csv https://raw.githubusercontent.com/erkansirin78/datasets/refs/heads/master/dirty_store_transactions.csv',
